...
const TargetCursor = ({
  targetSelector = '.cursor-target, button, [role="button"], a, input, select, .toolbox-item, .solver-card-btn, .header-tool-btn, .header-pill-chip, .unit-pill-chip, .preset-btn, .tab-btn, .canvas-icon-btn, .ribbon-tool-btn, .contributor-card',
  spinDuration = 2,
